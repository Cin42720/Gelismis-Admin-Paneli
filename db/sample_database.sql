...
-- Ornek MySQL veritabani: tablo, trigger, function, procedure ve seed verileri.
-- Docker Compose ilk kurulumda db/init/01_schema.sql dosyasini otomatik calistirir.
